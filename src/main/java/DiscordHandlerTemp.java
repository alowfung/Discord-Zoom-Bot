...
//        System.out.println(event.getMember().deafen(DiscordHandler.deafen()));
//        System.out.println(Objects.requireNonNull(event.getGuild().getMember(event.getAuthor())).deafen(DiscordHandler.deafen()));
//        System.out.println(Objects.requireNonNull(event.getGuild().getMember(event.getAuthor())).deafen(DiscordHandler.deafen()));
////        System.out.println(event.getMember().deafen(DiscordHandler.deafen()));
